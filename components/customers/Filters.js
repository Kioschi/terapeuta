...
import showUser from "../../scripts/customers/showCustomer";
        ...
        <Grid item container xs={12} sx={{mt: 5}} spacing={2}>
            ...
            </Grid>
            {
                visible && <>
                    ...
                    <Grid item xs={12} md={2}>
                        <TextField fullWidth label="Telefon" variant="outlined" size={'small'} onChange={ e => setData({...data, tel: e.target.value})}/>
                    </Grid>
                    <Grid item xs={12} md={2}>
                        <TextField fullWidth label="Email" variant="outlined" size={'small'} onChange={ e => setData({...data, email: e.target.value})}/>
                    </Grid>
